...
public:
    ...
    void draw(bool textureEnable, GLboolean ts, int animationEnable);
...
void Parab::draw(bool textureEnable, GLboolean ts, int animationEnable) {
